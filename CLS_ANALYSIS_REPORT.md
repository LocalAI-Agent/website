...
```html
<section class="relative bg-page dark:bg-dark overflow-hidden md:py-32 py-20"></section>
```
...
>
  <div class="absolute inset-0 pointer-events-none" style="min-height: 500px; contain: layout;">
    <Image width={1920} height={1080} style="aspect-ratio: 16/9; min-height: 500px;" />
  </div>
</section>
```
...
<script src="https://seo-fixer.writesonic.com/site-audit/fixer-script/index.js" defer async></script>
<script defer async>
